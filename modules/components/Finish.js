...
export const Finish = () => {
  document.body.insertAdjacentHTML('beforeend', `
    <div class="finish-wrap">
      ...
      <div class="finish">
        <div class="finish__text-wrap">
          <div class="finish__text">
            <h3 class="finish__title">Episode IV</h3>
            <h3 class="finish__subtitle">A NEW HOPE</h3>
            <div>
              <p>A long time ago, in a galaxy far, far, away...</p>
              <p>A vast sea of stars serves as the backdrop for the main title.
              ...
              <p>Pursued by the Empire's sinister agents, Princess
                ...
                restore freedom to the galaxy...</p>
              <p>The awesome yellow planet of Tatooine emerges from a total
                ...
                the main solar fin of the Rebel craft to disintegrate.</p>
              <p>A New Hope is a classic science fiction film that has captivated audiences for over four decades.
                Released
                in 1977, the movie was written and directed by George Lucas, and was the first installment in the Star
                Wars
                franchise. The film takes place in a galaxy far, far away, and follows the adventures of Luke Skywalker,
                Princess Leia, and Han Solo as they battle against the evil Empire.</p>
              <p>The film begins with a classic opening crawl that sets the stage for the story. It tells the tale of the
                Rebel Alliance, a group of freedom fighters who are fighting against the tyranny of the Galactic Empire.
                The
                Empire, led by the villainous Darth Vader, has just completed construction of a new weapon, the Death
                Star,
                which has the power to destroy entire planets.</p>
              <p>We are then introduced to the film's protagonist, Luke Skywalker, a young farm boy who dreams of leaving
                his home planet and becoming a pilot. Luke's life is forever changed when he meets the wise Jedi Knight
                Obi-Wan Kenobi, who reveals to him that he is the son of a powerful Jedi Knight, and that his destiny is
                to
                save the galaxy from the clutches of the Empire.</p>
              <p>Along the way, Luke meets the charming rogue Han Solo and his loyal companion Chewbacca, and together
                they
                set out to rescue Princess Leia from the clutches of the Empire. Leia is a strong-willed princess who
                refuses to give up any information about the Rebel Alliance, even when faced with torture and threats of
                death.</p>
              <p>As the story progresses, Luke, Han, and Leia must work together to destroy the Death Star, which is
                headed
                towards the Rebel base on the planet Yavin. With the help of the Force and a skilled team of pilots, they
                manage to destroy the Death Star just moments before it reaches its target.</p>
              <p>The film is an epic adventure that features thrilling space battles, memorable characters, and a
                captivating story. It was a groundbreaking film in its time, and its impact can still be felt in popular
                culture today. Star Wars Episode IV: A New Hope is a must-see for any science fiction fan, and its legacy
                will continue to inspire future generations of filmmakers and audiences alike.</p>
              <p>A New Hope is a classic science fiction film that has captivated audiences for over four decades.
                Released
                in 1977, the movie was written and directed by George Lucas, and was the first installment in the Star
                Wars
